...
static const struct ggml_backend_api *g_sycl_backend;
#define ggml_backend_register g_sycl_backend->ggml_backend_register
#define ggml_is_quantized g_sycl_backend->ggml_is_quantized
#define ggml_type_size g_sycl_backend->ggml_type_size
#define ggml_blck_size g_sycl_backend->ggml_blck_size
#define ggml_is_transposed g_sycl_backend->ggml_is_transposed
#define ggml_nbytes g_sycl_backend->ggml_nbytes
#define ggml_get_unary_op g_sycl_backend->ggml_get_unary_op
#define ggml_nelements g_sycl_backend->ggml_nelements
#define ggml_nrows g_sycl_backend->ggml_nrows
#define ggml_is_permuted g_sycl_backend->ggml_is_permuted
#define ggml_is_contiguous g_sycl_backend->ggml_is_contiguous
#define ggml_op_name g_sycl_backend->ggml_op_name
#define ggml_type_name g_sycl_backend->ggml_type_name
#define ggml_element_size g_sycl_backend->ggml_element_size
#define ggml_row_size g_sycl_backend->ggml_row_size
#define ggml_element_size g_sycl_backend->ggml_element_size
#define ggml_element_size g_sycl_backend->ggml_element_size
#define ggml_rope_yarn_corr_dims g_sycl_backend->ggml_rope_yarn_corr_dims
#define ggml_backend_buft_alloc_buffer g_sycl_backend->ggml_backend_buft_alloc_buffer
#define ggml_backend_buft_get_alloc_size g_sycl_backend->ggml_backend_buft_get_alloc_size
#define ggml_backend_cpu_buffer_type g_sycl_backend->ggml_backend_cpu_buffer_type
#define ggml_backend_buffer_init g_sycl_backend->ggml_backend_buffer_init
#define ggml_backend_cpu_buffer_from_ptr g_sycl_backend->ggml_backend_cpu_buffer_from_ptr

GGML_CALL bool ggml_sycl_link(const struct ggml_backend_api *backend_api) {
    g_sycl_backend = backend_api;
